...
save(gibbs.list,file=paste(path,"gibbs_out_031212_G5000.RData",sep=""))


load(file=paste(path,"gibbs_out_031212_G5000.RData",sep=""))
...
# Sigma:
pdf(file=paste(path,"fig_tobit_trace_Sigma_P23.pdf",sep=""),width=8,height=6)
for (s in 1:S){
...
pdf(file=paste(path,"fig_tobit_trace_Sigma_Adiha_P23.pdf",sep=""),width=8,height=6)
...
# mu
pdf(file=paste(path,"fig_tobit_trace_mu_P23.pdf",sep=""),height=8,width=8)
par(mfrow=c(2,2))
for (p in 1:P){
