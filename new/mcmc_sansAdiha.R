...
##the data that the MCMC would be fun on, namely--replace series 11-15 with NA in Line 65
...
#Make all series for Adiha NA for a cross validation exericse
data[11:15,]<-NA
...
#IS THIS WRONG??? month.days starts in January, but nino starts in October
...
save(gibbs.list,file=paste(path,"gibbs_out_NA11172014_G5000.RData",sep=""))

#load(file=paste(path,"gibbs_out_11172014_G5000.RData",sep=""))
