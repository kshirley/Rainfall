#Comes from R_code_tobit_real3predict09.R, which comes from R_code_tobit_real3.R, but had to change 
##the data that the MCMC would be fun on, namely--shorten the time series to end in Dec 2008, Line 65. 
