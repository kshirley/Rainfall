...
X <- cbind(rep(1,T),(1:T)/6205-0.5,((1:T)/6205-0.5)^2,sin.mat[,1:4],cos.mat[,1:4],month.mat)
...
save(gibbs.list,file=paste(path,"gibbs_out_09262014_G5000.RData",sep=""))

'''
#load(file=paste(path,"gibbs_out_09262014_G5000.RData",sep=""))
...
pdf(file=paste(path,"fig_tobit_ppred-sd.pdf",sep=""),width=10,height=8)
par(mfrow=c(3,4))
for (i in 1:J.sum){
  for (m in 1:12){
